// src/pages/QuizzesPage.jsx - Mobile optimized
    ...
    <div className="py-3 md:py-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-3 md:gap-4">
        {filteredPapers.map(paper => {
          ...
          return (
            <div key={paper.id} onClick={() => handleQuizAction(paper)} className="bg-white rounded-xl shadow-md p-3 border border-gray-200 cursor-pointer">
